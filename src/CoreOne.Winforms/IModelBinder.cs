...
public interface IModelBinder
{
    ...
    /// </summary>
    /// <param name="container">The parent control that will host the generated form controls.</param>
    /// <param name="model">The model instance whose properties will be bound to controls.</param>
    ...
    /// <summary>
    /// Gets the currently bound model instance.
    /// </summary>
    /// <returns>The model object that is currently bound to controls, or null if no model is bound.</returns>
