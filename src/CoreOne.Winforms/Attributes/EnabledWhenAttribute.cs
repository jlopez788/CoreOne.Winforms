...
public sealed class EnabledWhenAttribute(string propertyName, object? expectedValue, ComparisonType comparisonType = ComparisonType.EqualTo) : WhenAttribute(propertyName, expectedValue, comparisonType)
{
}
